const CACHE = 'madhyum-crm-final-locked-v1';
const APP = [
  './','./index.html','./css/app.css','./js/app.js','./js/ui.js','./js/database.js','./js/config.js',
  './manifest.json','./icon/icon-192.png','./icon/icon-512.png'
];
